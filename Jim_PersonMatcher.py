...
newpath = r'A:\partners\%s' % newfolder
...
newpath2 = r'A:\partners\%s\request_%s_sf%s' % (newfolder, currentDate, newfolder2)
...
xmlFile = open("A:\partners\%s\\request_%s_sf%s\ZI_%s_%s.xml" % (newfolder, currentDate, newfolder2, client_name, job_name), "w")	
